package org.edupro.webapi.subject.controller;
...
import org.edupro.webapi.subject.service.SubjectService;
...
public class SubjectController extends BaseController<SubjectRes> {
    ...
    @PostMapping
    private ResponseEntity<Response> save(@RequestBody @Valid SubjectReq request){
        var result = service.save(request);
        return getResponse(result);
    }

    @PutMapping("/{id}")
    private ResponseEntity<Response> update(@RequestBody @Valid SubjectReq request,
