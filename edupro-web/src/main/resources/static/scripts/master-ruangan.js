$(document).ready(function () {
    ...
    var dt_ruangan_table = $("#table-ruangan"),
        statusObj = {
            0: {title: "Non Aktif"},
            1: {title: "Aktif"},
        },
    ...
    if (dt_ruangan_table.length > 0) {
        // datatable declaration

        var ajaxUrl = $('#ruangan-title').attr('href');
    ...
    // form submit
    $('#main-modal').on('submit', '#form-ruangan', function (e) {
        e.preventDefault();
    ...
    // edit data
    $("#table-ruangan").on('click', '.btn-edit', function () {
        var url = $(this).attr('href');
        showModal(url, ' ');
    });

    // delete data
    $("#table-ruangan").on('click', '.btn-delete', function () {
        var url = $(this).attr('href');
        showModal(url, ' ')
    });
