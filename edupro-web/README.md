...
```
cd existing_repo
git remote add origin https://gitlab.com/gentara-psm/edupro-web.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/gentara-psm/edupro-web/-/settings/integrations)
